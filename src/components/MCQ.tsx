    ...
    return (
      <div className="absolute flex flex-col justify-center -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
        ...
        <Link
          ...
          className={cn(buttonVariants({ size: "lg" }), "mt-2 text-white font-bold")}
        >
          View Statistics
  ...
  return (
    <div className="absolute -translate-x-1/2 -translate-y-1/2 md:w-[80vw] max-w-4xl w-[90vw] top-1/2 left-1/2">
      ...
      <div className="flex flex-col items-center justify-center w-full mt-4">
        {options.map((option, index) => {
          ...
          return (
            <Button
              key={index}
              className={cn(
                "justify-start w-full py-8 mb-4 transition rounded-lg",
                isSelected
            ...
            >
              <div className="flex items-center justify-start">
                <div
                  className={`
                    p-2 px-3 mr-5 border rounded-md ${
                    isSelected
                      ? "bg-black-500 text-white border-black"
        ...
        <Button
          variant="default"
          className="mt-2 bg-black text-white font-bold"
          size="lg"
